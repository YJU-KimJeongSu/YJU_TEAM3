...
import javax.swing.JPanel;
	...
	public class Main extends JFrame{
	   ...
	   static JPanel page1=new JPanel() {
	      /*이미지*/
	      Image background=new ImageIcon(Main.class.getResource("../images/mainBackground.png")).getImage();
	   ...
	   static JPanel page2=new JPanel() {
	      /*이미지*/
	      Image background=new ImageIcon(Main.class.getResource("../images/aisleBackground.png")).getImage();
	      public void paint(Graphics g) {//그리는 함수
	            g.drawImage(background, 0, 0, null);//background를 그려줌      
	      }
	   };
	   ...
	   public void customcursor(){
	      ...
	      Image cursorimage=tk.getImage(".../images/nextButton.png");
